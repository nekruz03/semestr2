...
public class InputHandler {
     ...
     */
    public static void InputLoader(String[] args, PriorityQueue<SpaceMarine> priorityQueue) {
        arguments = args;
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]));
            ...
            do {
                ...
                if (line == null) break;
                if (line.length != 9) {
                    logger.warn("Не удалось загрузить элемент. Строка имеет неверный формат");
                } else {
            ...
            logger.error("Неверное имя файла. Попробуйте ввести ещё раз.");
            System.exit(-1);
        } catch (Exception e) {
